...
export PF_INFO="ascii title kernel shell uptime pkgs memory palette"
export SHELL="zsh" pfetch
export HOSTNAME="tstation" pfetch
...
# dotnet tools (for github credentials)
export PATH="$PATH:/home/rsm/.dotnet/tools"

# cabinet
export CAB_REPO="https://github.com/rohanmalhi/dotfiles.git"
